...
java -jar lib/saxon9he.jar -xsl:xsl/bundle.xsl -s:raw/z_ifttt_clusterProperties.bundle.raw -o:../add-ons/bundles/ifttt/z_ifttt_clusterProperties.bundle
#
# get folder 'IFTTT':
...
java -jar lib/saxon9he.jar -xsl:xsl/bundle.xsl -s:raw/z_ifttt_folders.bundle.raw -o:../add-ons/bundles/ifttt/z_ifttt_folders.bundle
java -jar lib/saxon9he.jar -xsl:xsl/removeEntitiesFromFolderBundle.xsl -s:../add-ons/bundles/ifttt/z_ifttt_folders.bundle -o:../add-ons/bundles/ifttt/z_ifttt_folders.bundle
#
...
java -jar lib/saxon9he.jar -xsl:xsl/bundle.xsl -s:raw/otk_02_clusterProperties.bundle.raw -o:../add-ons/bundles/otk/otk_02_clusterProperties.bundle
#
# get folder 'OTK':
...
java -jar lib/saxon9he.jar -xsl:xsl/bundle.xsl -s:raw/otk_03_folders.bundle.raw -o:../add-ons/bundles/otk/otk_03_folders.bundle
java -jar lib/saxon9he.jar -xsl:xsl/removeEntitiesFromFolderBundle.xsl -s:../add-ons/bundles/otk/otk_03_folders.bundle -o:../add-ons/bundles/otk/otk_03_folders.bundle
#
...
java -jar lib/saxon9he.jar -xsl:xsl/bundle.xsl -s:raw/otk_04_unreferencedEncas.bundle.raw -o:../add-ons/bundles/otk/otk_04_unreferencedEncas.bundle
java -jar lib/saxon9he.jar -xsl:xsl/removeEntitiesFromFolderBundle.xsl -s:../add-ons/bundles/otk/otk_04_unreferencedEncas.bundle -o:../add-ons/bundles/otk/otk_04_unreferencedEncas.bundle
#
...
java -jar lib/saxon9he.jar -xsl:xsl/bundle.xsl -s:raw/otk_05_scheduledTasks.bundle.raw -o:../add-ons/bundles/otk/otk_05_scheduledTasks.bundle
